...
--
-- Host: 127.0.0.1
-- Generation Time: May 02, 2017 at 06:27 AM
...
(9924, 'ashma', 2017, 4, 'asd', 'ashma_mj.pdf', 'java c', 'cse', 6),
(9926, 'project176', 2016, 4, 'asd', 'ashma.pdf', 'java python', 'cse', 8),
(9927, 'qwertyuiop[', 2012, 4, 'asd', 'Ashma-MJ.pdf', 'python php html', 'cse', 10),
(9928, 'Project 1', 2016, 4, 'asd', 'project1.pdf', 'print just ', 'cse', 4),
(9929, 'project 2', 2017, 4, 'asd', 'project2.pdf', 'repository', 'cse', 3),
(9930, 'project 3', 2015, 4, 'asd', 'project3.pdf', 'leave management', 'cse', 0);
...
('', '', '', 3, '', ''),
('ashik', 'csu14116', 'qwerty', 3, 'cs', ''),
('ashma', 'CSU1417', 'hello1', 0, 'cs', '');
...
--
ALTER TABLE `project`
  MODIFY `pid` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9931;
